...
- Generated: 2026-03-09T03:48:05.302Z
- Started: 2026-03-09T03:46:49.074Z
- Overall risk: **HIGH**
...
> vitest run --coverage
 ...
 Test Files  4 passed (4)
      Tests  22 passed (22)
   Start at  20:47:43
   Duration  899ms (transform 209ms, setup 263ms, import 247ms, tests 9ms, environment 1.93s)
...
- Summary: requests=504630, errorRate=100%, p95Ms=0
```text
...
Running load check against http://127.0.0.1:4000/v1/me/review-queue?limit=20 with concurrency=10, duration=20s
{
  ...
  "concurrency": 10,
  "durationSeconds": 20,
  "totalRequests": 504630,
  "successes": 0,
  "failures": 504630,
  "errorRate": 100,
  "requestsPerSecond": 25231.5,
  "p50Ms": 0,
  "p95Ms": 0,
  "p99Ms": 0,
  "maxMs": 0
