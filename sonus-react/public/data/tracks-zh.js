...
const LESSON_BANDS = [
  {
    ...
    units: [
      { id: 'b1-getting-started', icon: 'volume-2', name: 'Getting Started', hanzi: '入门', words: 20 },
      { id: 'b1-pronouns', icon: 'user', name: 'Pronouns', hanzi: '代词', words: 23 },
      { id: 'b1-politeness', icon: 'smile', name: 'Politeness', hanzi: '礼貌表达', words: 11 },
      { id: 'b1-numbers', icon: 'hash', name: 'Numbers & Counting', hanzi: '数字', words: 17 },
      { id: 'b1-time', icon: 'clock', name: 'Time & Dates', hanzi: '时间', words: 47 },
      { id: 'b1-measure', icon: 'layers', name: 'Measure Words', hanzi: '量词', words: 16 },
      { id: 'b1-verbs-1', icon: 'activity', name: 'Verbs I', hanzi: '动词一', words: 26 },
      { id: 'b1-family', icon: 'users', name: 'Family', hanzi: '家庭', words: 42 },
      { id: 'b1-routine', icon: 'sun', name: 'Daily Life & Routine', hanzi: '日常', words: 30 },
      { id: 'b1-food', icon: 'utensils', name: 'Food & Drink', hanzi: '食物', words: 23 },
      { id: 'b1-shopping', icon: 'shopping-bag', name: 'Shopping', hanzi: '购物', words: 12 },
      { id: 'b1-locations', icon: 'map-pin', name: 'Locations', hanzi: '地点', words: 30 },
      { id: 'b1-directions', icon: 'compass', name: 'Directions', hanzi: '方向', words: 37 },
      { id: 'b1-transport', icon: 'bus', name: 'Transport', hanzi: '交通', words: 27 },
      { id: 'b1-school', icon: 'book', name: 'Work & School', hanzi: '工作/学习', words: 46 },
      { id: 'b1-questions', icon: 'help-circle', name: 'Question Words', hanzi: '疑问词', words: 7 },
      { id: 'b1-verbs-2', icon: 'activity', name: 'Verbs II', hanzi: '动词二', words: 22 },
      { id: 'b1-opinions', icon: 'message-circle', name: 'Opinions', hanzi: '意见', words: 26 },
      { id: 'b1-ability', icon: 'zap', name: 'Ability', hanzi: '能力', words: 9 },
      { id: 'b1-verbs-3', icon: 'activity', name: 'Verbs III', hanzi: '动词三', words: 24 },
      { id: 'b1-comparison', icon: 'git-compare', name: 'Comparisons', hanzi: '比较', words: 12 },
