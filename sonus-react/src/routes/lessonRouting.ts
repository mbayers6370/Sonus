...
const LEGACY_LEVEL_BY_ID: Record<string, LessonBand> = {
  ...
  band1: { id: 'band1', band: 1, name: 'Elementary I', title: 'Elementary I', subtitle: 'Foundations · Everyday Use', wordCount: 500, wordRange: '0–500', color: 'bg-[var(--sonus-palette-green)]', description: 'Foundations · Everyday Use', units: [] },
  band2: { id: 'band2', band: 2, name: 'Elementary II', title: 'Elementary II', subtitle: 'Expanded Daily Life', wordCount: 1272, wordRange: '500–1272', color: 'bg-[var(--sonus-palette-green)]', description: 'Expanded Daily Life', units: [] },
  band3: { id: 'band3', band: 3, name: 'Pre‑Intermediate', title: 'Pre‑Intermediate', subtitle: 'Simple Narratives', wordCount: 2245, wordRange: '1272–2245', color: 'bg-[var(--sonus-palette-blue)]', description: 'Simple Narratives', units: [] },
  band4: { id: 'band4', band: 4, name: 'Intermediate I', title: 'Intermediate I', subtitle: 'Intermediate Topics', wordCount: 3245, wordRange: '2245–3245', color: 'bg-[var(--sonus-palette-blue)]', description: 'Intermediate Topics', units: [] },
...
const JAPANESE_LEVEL_BY_ID: Record<string, LessonBand> = {
  n5: { id: 'n5', band: 0, name: 'N5', title: 'N5', subtitle: 'Basic', wordCount: 0, wordRange: '', color: 'bg-[var(--sonus-palette-green)]', description: 'Basic', units: [] },
  n4: { id: 'n4', band: 0, name: 'N4', title: 'N4', subtitle: 'Elementary', wordCount: 0, wordRange: '', color: 'bg-[var(--sonus-palette-blue)]', description: 'Elementary', units: [] },
