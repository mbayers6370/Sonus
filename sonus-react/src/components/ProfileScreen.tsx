    ...
    <div className="min-h-screen page-shell px-6 pt-14 pb-24">
      <div className="relative mb-8">
        ...
        <div className="text-center px-12">
          <h1 className="font-playfair text-5xl font-normal text-text-dark mb-2">Profile</h1>
          <h2 className="text-base text-text-med italic">Account settings</h2>
        </div>
      </div>
      ...
      {saveMessage && (
        <div className="bg-white border border-[#4D7C0F] rounded-2xl p-4 text-sm text-[#4D7C0F] mb-4">
          {saveMessage}
        </div>
      )}
      ...
      <div className="bg-white border border-border rounded-2xl p-5 mb-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-[rgba(30,58,138,0.12)] border border-[rgba(30,58,138,0.22)] flex items-center justify-center text-[#1E3A8A]">
      ...
      <div className="bg-white border border-border rounded-2xl p-5 mb-4">
        ...
        <div className={`space-y-3 transition-opacity ${isEditing ? 'opacity-100' : 'opacity-55'}`}>
          <div>
          ...
          {isEditing ? (
            <button
              ...
              disabled={saving}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#1E3A8A] text-white text-sm font-semibold disabled:opacity-60"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border text-text-dark text-sm font-semibold hover:bg-[rgba(55,65,81,0.08)]"
            >
              Edit Profile
            </button>
          )}
      ...
      <button
        ...
        className="w-full bg-white border border-border rounded-2xl p-5 mb-4 text-left hover:bg-[rgba(55,65,81,0.04)] transition-colors"
      >
        ...
        <div className="mt-3 text-sm text-[#1E3A8A] font-medium">Open full progress →</div>
      </button>
      ...
      <div className="bg-white border border-border rounded-2xl p-5 mb-4">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#1E3A8A] text-white text-sm font-semibold disabled:opacity-60"
          >
      ...
      <div className="space-y-3">
        <button
          onClick={onOpenAbout}
          className="w-full bg-white border border-border rounded-2xl p-4 text-left flex items-center justify-between hover:bg-[rgba(55,65,81,0.05)] transition-colors"
        >
          <div>
          ...
          <div className="w-full max-w-sm bg-white border border-border rounded-2xl p-5">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 px-3 py-2 rounded-lg bg-[#1E3A8A] text-white text-sm font-semibold disabled:opacity-60"
              >
