    ...
    >
      ...
      >
        <section className="px-4 py-8 sm:px-8 sm:py-12">
          <div className="mx-auto w-full max-w-6xl rounded-xl border border-[#94A3B8] bg-white p-5 shadow-[0_14px_30px_-24px_rgba(15,23,42,0.6)]">
            <h1 className="main-font text-title-page leading-tight text-[var(--sonus-palette-charcoal)] sm:text-4xl">{title}</h1>
