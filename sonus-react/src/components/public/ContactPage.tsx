        ...
        <form className="mt-4 grid gap-3" onSubmit={handleSubmit}>
          <label className="text-sm text-[#1F2A37]">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-[#CBD5E1] px-3 py-2 text-sm outline-none focus:border-[#4C5A6A]"
          ...
          <label className="text-sm text-[#1F2A37]">
            ...
            <textarea
              ...
              className="mt-1 min-h-28 w-full rounded-lg border border-[#CBD5E1] px-3 py-2 text-sm outline-none focus:border-[#4C5A6A]"
