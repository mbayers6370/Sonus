export const TERMS_OF_SERVICE_LAST_UPDATED = '2026-03-08';
export const PRIVACY_POLICY_LAST_UPDATED = '2026-03-07';
  ...
  return (
    <>
      ...
      <section>
        ...
        <p className="mt-2">
          Sonus stores practice and progress records needed to operate the service, including activity progress,
          streaks, quiz attempts, speak attempts, review state, feature progression state, and Travel Sprint phrase
          states such as learned, locked, or checked status.
        </p>
