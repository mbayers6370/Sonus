            ...
            <div className="relative flex items-center justify-center">
              {showBackButton ? (
                <button
                  ...
                  aria-label="Go back"
                  className="absolute left-0 md:left-2 top-1/2 -translate-y-1/2 w-9 h-9 md:w-10 md:h-10 rounded-full border border-[rgba(55,65,81,0.22)] bg-white/72 text-text-dark inline-flex items-center justify-center"
                >
          ...
          <div className="h-full px-4 md:px-6 flex flex-col md:flex-row items-center justify-center relative">
            {showBackButton ? (
              <button
                ...
                aria-label="Go back"
                className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 w-9 h-9 md:w-10 md:h-10 rounded-full border border-[rgba(55,65,81,0.22)] bg-white/72 text-text-dark inline-flex items-center justify-center"
              >
                <ChevronLeft className="w-5 h-5" />
              </button>
            ) : null}
