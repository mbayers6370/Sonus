  ...
  return (
    <div className="min-h-screen page-shell px-6 with-bottom-nav">
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        {backendOffline && (
          <div className="bg-white border border-[rgba(25,50,50,0.35)] rounded-2xl p-5 text-sm text-text-med">
        ...
        <section className="grid grid-cols-1 gap-3 lg:grid-cols-12">
          <div className="rounded-3xl border border-[rgba(25,50,50,0.45)] bg-white p-5 text-center sm:text-left shadow-[0_16px_36px_-30px_rgba(15,23,42,0.24)] lg:col-span-7">
        ...
        <section className="rounded-3xl border border-[rgba(25,50,50,0.45)] bg-white p-5 text-center sm:text-left shadow-[0_16px_36px_-30px_rgba(15,23,42,0.24)]">
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  {visibleNeedsWork.map((item) => {
                    ...
                    return (
                      <div
                        key={item.wordId}
                        className="rounded-2xl border border-[rgba(25,50,50,0.30)] bg-[#FBFBF9] p-5 text-center sm:text-left min-h-[124px] flex flex-col justify-between"
                      >
                        <div>
