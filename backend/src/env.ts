...
const envSchema = z
  .object({
    ...
    SRS_MIN_INTERVAL_DAYS: z.coerce.number().min(0).default(1),
    SRS_MAX_INTERVAL_DAYS: z.coerce.number().min(1).default(3650),
    TELEMETRY_QUIZ_MISS_RATE_WARN_PCT: z.coerce.number().min(0).max(100).default(70),
